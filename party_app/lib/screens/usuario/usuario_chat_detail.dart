...
class UsuarioChatDetail extends StatefulWidget {
  final String otherUserUid;

  const UsuarioChatDetail({super.key, required this.otherUserUid});

  @override
  State<UsuarioChatDetail> createState() => _UsuarioChatDetailState();
}

class _UsuarioChatDetailState extends State<UsuarioChatDetail> {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: FutureBuilder<Map<String, dynamic>?>(
          future: Queries.getGrupoInfo(widget.otherUserUid),
